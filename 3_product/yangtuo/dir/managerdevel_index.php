...
chkLogin("managerdevel_index.php");//微信登录授权
...
function go(id)
{
	location.href="managerdevel_detail.php?id=" +id;
}
 </script>
...
<div align="right" class="head_menu"><a href="managerdevel_code.php">添加业务经理</a></div>
   <?php 
	...
	<tr onclick="go(<?php echo $row["id"]?>)">
		...
		<td class="bt1">
			...
			<div class="hbt2">联系电话:<?php echo  $row["tel"]; ?>
				<font>发展业务员:<?php echo $row["devel_count"]; ?>人</font>
			</div>
		</td>
	</tr>
	<?php 
